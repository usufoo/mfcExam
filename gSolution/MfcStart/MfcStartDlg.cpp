...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT_NUM, eNum1);
	DDX_Text(pDX, IDC_EDIT_NUM2, eNum2);
}
...
void CMfcStartDlg::OnBnClickedBtnTest()
{
	...
	UpdateData(true);
	int testNum1 = GetDlgItemInt(IDC_EDIT_NUM);
	int testNum2 = GetDlgItemInt(IDC_EDIT_NUM2);
	SetDlgItemInt(IDC_STATIC_RESULT, testNum1 + testNum2);
	...
	//}
	//eNum1 = nSum;
	//SetDlgItemText(IDC_STATIC_RESULT, _T("RRRR"));
	//UpdateData(false);
}
